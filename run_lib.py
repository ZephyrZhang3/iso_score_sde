...
def train(config, workdir):
    ...
    if config.training.sde.lower() == "vpsde":
        ...
        # isoVPSDE does not require beta_min and beta_max
        # but requires some data to generate the schedule_fn
        num_gen_schedule_samples = config.model.num_gen_schedule_samples
        ...
        if batch_np.shape[0] < num_gen_schedule_samples:
        ...
        batch_np = batch_np[:num_gen_schedule_samples]
